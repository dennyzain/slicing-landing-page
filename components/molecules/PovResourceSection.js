export default function PovResourceSection() {
  return (
    <section>
      <div className="px-[32px] pt-[162px] bg-black h-auto lg:px-36 xl:px-[373.5px] ">
        <h3 className="font-black text-[32px] text-white lg:text-center">POV</h3>
        ...
        <h3 className="font-black text-[32px] pt-[67px] text-white lg:text-center">Resource</h3>
